  ...
  _createClass(JoyrideTooltip, [{
    ...
    value: function render() {
      ...
      var _props$step = this.props.step,
          casecStyle = _props$step.casecStyle,
          casecClass = _props$step.casecClass;

      if (casecClass) opts.classes.push(casecClass);

      output.tooltipComponent = _react2.default.createElement(
        'div',
        { className: opts.classes.join(' '), style: Object.assign(styles.tooltip, casecStyle), 'data-target': selector },
          ...
          _react2.default.createElement(
            'button',
            {
              ...
              onClick: function onClick(e) {
                _onClick(e);if (document.getElementById('back_button_joyride')) document.getElementById('back_button_joyride').blur();document.getElementById('next_button_joyride').blur();
              } },
            buttons.primary
          )
        )
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          style: overlayStyles,
          'data-type': 'close',
          onClick: !disableOverlay ? _onClick : undefined },
        output.hole,
